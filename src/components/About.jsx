      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="bg-gray-50 rounded-2xl p-10 shadow hover:shadow-lg transition border-2 border-[#FF770F]">
          ...
          <p className="text-lg leading-relaxed text-center">
            At Datani Insurance, we believe insurance is more than just cover — it’s about being there when it counts. We offer{" "}
            <span className="text-black font-semibold">service that shields</span>: expert advice, reliable protection, and personal support.
          </p>
        </div>
