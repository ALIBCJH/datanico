    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-600 text-lg max-w-3xl text-center mx-auto mb-16">
          Empower your financial future by making informed decisions. These
          simple yet powerful tips help you get the most out of your coverage.
        </p>

        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {tips.map(({ title, description, icon: Icon }, index) => (
            <div
              key={index}
